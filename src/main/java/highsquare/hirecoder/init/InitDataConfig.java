...
public class InitDataConfig {
    ...
    static class InitDataForH2 extends InitData {
        ...
        private void setCommentConstraint() {
            String dropLikeOnCommentFKQuery = "ALTER TABLE PUBLIC.LIKE_ON_COMMENT DROP CONSTRAINT FK_COMMENT__LIKE_ON_COMMENT;";
        ...
        private void setBoardConstraint() {
            String dropCommentFKQuery = "ALTER TABLE PUBLIC.COMMENT DROP CONSTRAINT FK_BOARD__COMMENT;";
            ...
            String dropBoardTagFKQuery = "ALTER TABLE PUBLIC.BOARD_TAG DROP CONSTRAINT FK_BOARD__BOARD_TAG;";
            ...
            String dropLikeOnBoardFKQuery = "ALTER TABLE PUBLIC.LIKE_ON_BOARD DROP CONSTRAINT FK_BOARD__LIKE_ON_BOARD;";
            ...
            String dropBoardImageFKQuery = "ALTER TABLE PUBLIC.BOARD_IMAGE DROP CONSTRAINT FK_BOARD__BOARD_IMAGE;";
        ...
        private void setStudyConstraint() {
            String dropBoardFKQuery = "ALTER TABLE PUBLIC.BOARD DROP CONSTRAINT FK_STUDY__BOARD;";
            String dropStudyMemberFKQuery = "ALTER TABLE PUBLIC.STUDY_MEMBER DROP CONSTRAINT FK_STUDY__STUDY_MEMBER;";
            ...
            String dropApplyForStudyFKQuery = "ALTER TABLE PUBLIC.APPLY_FOR_STUDY DROP CONSTRAINT FK_STUDY__APPLY_FOR_STUDY;";
        ...
        private void setMemberConstraint() {
            String dropApplyForStudyFKQuery = "ALTER TABLE PUBLIC.APPLY_FOR_STUDY DROP CONSTRAINT FK_MEMBER__APPLY_FOR_STUDY;";
            ...
            String dropStudyMemberFKQuery = "ALTER TABLE PUBLIC.STUDY_MEMBER DROP CONSTRAINT FK_MEMBER__STUDY_MEMBER;";
            ...
            String dropLikeOnBoardFKQuery = "ALTER TABLE PUBLIC.LIKE_ON_BOARD DROP CONSTRAINT FK_MEMBER__LIKE_ON_BOARD;";
            ...
            String dropBoardFKQuery = "ALTER TABLE PUBLIC.BOARD DROP CONSTRAINT FK_MEMBER__BOARD;";
            ...
            String dropCommentFKQuery = "ALTER TABLE PUBLIC.COMMENT DROP CONSTRAINT FK_MEMBER__COMMENT;";
            ...
            String dropLikeOnCommentFKQuery = "ALTER TABLE PUBLIC.LIKE_ON_COMMENT DROP CONSTRAINT FK_MEMBER__LIKE_ON_COMMENT;";
            ...
            String dropManagerFKQuery = "ALTER TABLE PUBLIC.STUDY DROP CONSTRAINT FK_MANAGER__STUDY;";
        ...
        private void setApplyForStudyConstraint() {
            String dropApplyForStudyFKQuery = "ALTER TABLE PUBLIC.MESSAGE_FOR_APPLICATION DROP CONSTRAINT FK_APPLY_FOR_STUDY__MESSAGE_FOR_APPLICATION;";
